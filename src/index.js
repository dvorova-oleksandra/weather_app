...
function handleSubmit(event) {
  ...
  finding_city(info.value);
}
//For show Fahrenheit 
function displayFahrenheitTemperature(event) {
  event.preventDefault();
  let temperatureElement = document.querySelector(".gra");
...
for (let i = 0; i <5;i++)
{
  ...
  if (days<=6)
  {
    if (i==0)
    {
      ...
      first.innerHTML = weekday[days]
    }
    if (i==1)
    {
      let second = document.querySelector("#second")
      second.innerHTML = weekday[days]
    }
    if (i==2)
    {
      let third = document.querySelector("#third")
      third.innerHTML = weekday[days];
    }
    if (i==3)
    {
      let fourth = document.querySelector("#fourth")
      fourth.innerHTML = weekday[days]
    }
    if (i==4)
    {
      let fiveth = document.querySelector("#fiveth")
      fiveth.innerHTML = weekday[days]
  }
}
else 
{ 
...
for (let y = t; y<5;y++)
{
  ...
  if (d<=6)
  {
    ...
    {
      let first = document.querySelector("#first")
      first.innerHTML = weekday[d]
    }
    if (y==1)
    {
      let second = document.querySelector("#second")
      second.innerHTML = weekday[d]
    }
    if (y==2)
    {
      let third = document.querySelector("#third")
      third.innerHTML = weekday[d];
    }
    if (y==3)
    {
      let fourth = document.querySelector("#fourth")
      fourth.innerHTML = weekday[d]
    }
    if (y==4)
    {
      let fiveth = document.querySelector("#fiveth")
      fiveth.innerHTML = weekday[d]
  }
}
}